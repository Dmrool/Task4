    ...
    public abstract class LivingBeing : ILivingBeing
    {
        ...
        public virtual string Move()
        {
            ...
            if (CurrentSpeed >= MaxSpeed)
            {
                ...
                return $"Разогнался/лась с {oldSpeed:F1} до {CurrentSpeed:F1} км/ч - Достигнута максимальная скорость!";
            }
            return $"Разогнался/лась с {oldSpeed:F1} до {CurrentSpeed:F1} км/ч";
        }
        ...
        public virtual string Stand()
        {
            ...
            {
                CurrentSpeed = 0;
                return $"Замедлился/лась с {oldSpeed:F1} до 0 км/ч - Полная остановка!";
            }
            return $"Замедлился/лась с {oldSpeed:F1} до {CurrentSpeed:F1} км/ч";
        }
